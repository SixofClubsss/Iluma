module github.com/SixofClubsss/Iluma

go 1.20

require (
	fyne.io/fyne/v2 v2.3.1
	github.com/civilware/Gnomon v0.0.0-20230703161103-0df35ac89055
	github.com/dReam-dApps/dReams v0.9.7-0.20230703023132-a03af8d7d74b
